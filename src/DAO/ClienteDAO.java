...
public class ClienteDAO {
    ...
    public boolean inserirCliente(Cliente cliente) {
        try(Connection conn = conexao.conectar();
            PreparedStatement novoCliente = conn.prepareStatement("INSERT INTO clientes" +
    ...
    public boolean atualizarCliente(Cliente cliente) {
        try(Connection conn = conexao.conectar();
            PreparedStatement clienteAtualizado = conn.prepareStatement("UPDATE clientes" +
                    " SET nome=?, cpf = ?, telefone = ?, email = ? WHERE idCliente = ?;")){
            ...
            clienteAtualizado.setInt(5, cliente.getIdCliente());
    ...
    public boolean deletarCliente(int idCliente) {
        try(Connection conn = conexao.conectar();
            PreparedStatement clienteDeletado = conn.prepareStatement("DELETE FROM" +
